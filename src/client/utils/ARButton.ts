...
import type { Navigator } from 'webxr';
 ...
 class ARButton{
    ...
    private onSessionStart : any;
    private onSessionEnd : any;
	...
	showStartAR( button : HTMLButtonElement ) {
        ...
        button.onclick = function () {
            ...
            if ( currentSession === null ) {
                ...
                if(self.xr != null)
                    self.xr.requestSession( 'immersive-ar', self.sessionInit ).then(res => {
                        onSessionStarted(res);
                    });
    ...
    showARNotSupported( button : HTMLButtonElement ) {
    ...
    stylizeElement( element:HTMLElement, active = true, fontSize = 13, ignorePadding = false ) {
